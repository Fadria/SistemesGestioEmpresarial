            ...
            for recordPartido in self.env['liga.partido'].search([]):  
                ...
                if recordPartido.equipo_casa.nombre==recordEquipo.nombre:
                    ...
                    if recordPartido.goles_casa>recordPartido.goles_fuera:
                        ...
                        # Si tenemos una diferencia de 4 goles daremos 4 puntos al ganador
                        if abs(recordPartido.goles_casa - recordPartido.goles_fuera) >= 4:
                            recordEquipo.puntos += 4
                        else:
                            recordEquipo.puntos += 3 # Sin esta diferencia cuentan 3 puntos

                    elif recordPartido.goles_casa<recordPartido.goles_fuera:
                        recordEquipo.derrotas=recordEquipo.derrotas+1

                        # Si tenemos una diferencia de 4 goles daremos -1 puntos al perdedor
                        if abs(recordPartido.goles_casa - recordPartido.goles_fuera) >= 4:
                            recordEquipo.puntos += -1
                    else:
                        recordEquipo.empates=recordEquipo.empates+1
                        recordEquipo.puntos += 1 # Los empates cuentan como 1 punto
                ...
                if recordPartido.equipo_fuera.nombre==recordEquipo.nombre:
                    ...
                    if recordPartido.goles_casa<recordPartido.goles_fuera:
                        ...
                        # Si tenemos una diferencia de 4 goles daremos 4 puntos al ganador
                        if abs(recordPartido.goles_fuera - recordPartido.goles_casa) >= 4:
                            recordEquipo.puntos += 4 # Las victorias con esta diferencia cuentan 4 puntos
                        else:
                            recordEquipo.puntos += 3 # Sin esta diferencia cuentan 3 puntos
